...
const AccountPage = () => {
  ...
  const handleDelete = async (userId) => {
    try {
      ...
      showAlert('An error occurred while deleting the user.', 'red');    
    }
  };
    ...
    <Box>
      ...
      <TableContainer>
        <Table>
          <TableHead>
            <TableRow>
              <TableCell sx={{ backgroundColor: '#FFD2A5', fontWeight: 'bold', borderTopLeftRadius: '8px' }}>User</TableCell>
              <TableCell sx={{ backgroundColor: '#FFD2A5', fontWeight: 'bold' }}>Email</TableCell>
              <TableCell sx={{ backgroundColor: '#FFD2A5', fontWeight: 'bold' }}>Role</TableCell>
